...
describe('Reducer: Reports', () => {
  ...
  test('REPLACE_DATA should return the initial state if payload has no reports array', () => {
    ...
    expect(reducer(INITIAL_STATE, { type: REPLACE_DATA, payload: {reports: 'wrong'} })).toEqual(INITIAL_STATE);
  });
  ...
  test('DATA_LOADED should return the initial state if payload has no reports array', () => {
    ...
    expect(reducer(INITIAL_STATE, { type: DATA_LOADED, payload: {reports: 'wrong'} })).toEqual(INITIAL_STATE);
  });
  ...
  test('REPLACE_REPORTS should return the initial state if payload has no reports array', () => {
    ...
    expect(reducer(INITIAL_STATE, { type: REPLACE_REPORTS, payload: {reports: 'wrong'} })).toEqual(INITIAL_STATE);
  });
  ...
  test('REPLACE_REPORTS should return payload replacing existing reports.', () => {
    ...
    const reducerResult = reducer(INITIAL_STATE, { type: REPLACE_REPORTS, payload: TEST_TEXTS });
  ...
  test('UPDATE_REPORT should update existing reports', () => {
    ...
    const reducerResult = reducer(INITIAL_STATE, { type: UPDATE_REPORT, payload: NEW_REPORT });
  ...
  test('ADD_REPORT should add the payload to existing reports', () => {
    ...
    const reducerResult = reducer(INITIAL_STATE, { type: ADD_REPORT, payload: NEW_REPORT });
    expect(JSON.stringify(reducerResult)).toEqual(JSON.stringify(EXPECTED_RESULT));
  });
  ...
  test('DELETE_REPORT should delete the report if the ID is found', () => {
    ...
    const reducerResult = reducer(INITIAL_STATE_DEL, { type: DELETE_REPORT, payload: INITIAL_STATE_DEL[1] });
