...
describe('Reducer: Texts', () => {
  ...
  test('REPLACE_DATA should return the initial state if payload has no texts array', () => {
    ...
    expect(reducer(INITIAL_STATE, { type: REPLACE_DATA, payload: {texts: 'wrong'} })).toEqual(INITIAL_STATE);
  });
  ...
  test('REPLACE_TEXTS should return the initial state if payload has no texts array', () => {
    ...
    expect(reducer(INITIAL_STATE, { type: REPLACE_TEXTS, payload: {texts: 'wrong'} })).toEqual(INITIAL_STATE);
  });
  ...
  test('REPLACE_TEXTS should return payload replacing existing texts.', () => {
    ...
    const reducerResult = reducer(INITIAL_STATE, { type: REPLACE_TEXTS, payload: TEST_TEXTS });
  ...
  test('UPDATE_TEXT should update existing texts', () => {
    ...
    const reducerResult = reducer(INITIAL_STATE, { type: UPDATE_TEXT, payload: NEW_TEXT });
  ...
  test('ADD_TEXT should add the payload to existing texts', () => {
    ...
    const reducerResult = reducer(INITIAL_STATE, { type: ADD_TEXT, payload: NEW_TEXT });
    expect(JSON.stringify(reducerResult)).toEqual(JSON.stringify(EXPECTED_RESULT));
  });
  ...
  test('DELETE_TEXT should delete the text if the ID is found', () => {
    ...
    const reducerResult = reducer(INITIAL_STATE_DEL, { type: DELETE_TEXT, payload: INITIAL_STATE_DEL[1] });
